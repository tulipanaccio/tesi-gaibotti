...
\end{itemize}
Inoltre, possiamo notare come nella figura \ref{fig:bassiniDEFOCUS} la sfocatura sia applicata su tutta l'immagine, mentre nella figura \ref{fig:pioggia} la sfocatura si concentri solo in alcune aree (quelle dove sono presenti le gocce). 
