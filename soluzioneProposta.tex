...
\begin{figure}
	\centering
	\begin{subfigure}[]
		{\label{fig:energyDefocus} \includegraphics[width=13cm]{./pictures/Defocus/DEFOCUS_energy}}
	\end{subfigure}
	\begin{subfigure}[]
		{\label{fig:lumaDefocus} \includegraphics[width=13cm]{./pictures/Defocus/DEFOCUS_luma}}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[]
		{\label{fig:energyDetrDefocus} \includegraphics[width=13cm]{./pictures/Defocus/DEFOCUS_energy_detr}}
	\end{subfigure}
	\begin{subfigure}[]
		{\label{fig:lumaDetrDefocus} \includegraphics[width=13cm]{./pictures/Defocus/DEFOCUS_luma_detr}}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[]
		{\label{fig:energyDisplacement} \includegraphics[width=13cm]{./pictures/Displacement/DISPLACEMENT_energy}}
	\end{subfigure}
	\begin{subfigure}[]
		{\label{fig:lumaDisplacement} \includegraphics[width=13cm]{./pictures/Displacement/DISPLACEMENT_luma}}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}[]
		{\label{fig:energyDetrDisplacement} \includegraphics[width=13cm]{./pictures/Displacement/DISPLACEMENT_energy_detr}}
	\end{subfigure}
	\begin{subfigure}[]
		{\label{fig:lumaDetrDisplacement} \includegraphics[width=13cm]{./pictures/Displacement/DISPLACEMENT_luma_detr}}
	\end{subfigure}
	\caption{Detrending dell'energia media del gradiente (a) e della luma (b) nel caso di uno spostamento della camera}
	\label{fig:ddisplacementDetrPLOt}
\end{figure}
