...
\end{figure}
Questi fenomeni fanno s\`i che i nostri indicatori abbiano una dinamica \textit{difficilmente prevedibile} e che \textit{non siano stazionari}\footnote{Ovvero non sono realizzazioni i.i.d. di una stessa variabile aleatoria}, come possiamo vedere negli esempi delle figure \ref{fig:energy} e \ref{fig:luma}.
...
%\begin{figure}[tb]
%	\centering
%	\begin{subfigure}[]{\label{fig:risultatoClustering} \includegraphics[width=6cm]{./pictures/segmentazione/mappa1}}
%	\end{subfigure}
%	\begin{subfigure}[]
%		{\label{fig:mappaFinale} \includegraphics[width=6cm]{./pictures/segmentazione/mappa2}}
%	\end{subfigure}
%	\caption{Risultato finale dell'algoritmo di clustering (a) e rifinitura delle regioni (b)}
%	\label{fig:clustering}
%\end{figure}

\subsection{Partizione dei feature vector per l'estrazione delle regioni}
...
Il risultato finale \`e quello in Figura \ref{fig:mappaFinale}, dove le zone colorate in blu scuro rappresentano i pixel che non vengono considerati durante l'analisi successiva.
\begin{figure}[tb]
	\centering
	\begin{subfigure}[]{\label{fig:risultatoClustering} \includegraphics[width=6cm]{./pictures/segmentazione/mappa1}}
	\end{subfigure}
