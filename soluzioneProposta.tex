...
%Nelle Figure \ref{fig:defocusPLOT} e \ref{fig:displacementPLOT} possiamo vedere il comportamento dell'energia media di gradiente e luma rispettivamente per un caso di sfocatura e per un caso di spostamento della camera.  
...
Dobbiamo fare un'ultima considerazione per quanto riguarda il comportamento degli indicatori.
Ci possono essere dei casi in cui un evento di tampering risulta difficilmente individuabile anche facendo il detrending degli indicatori.
%\cleartoevenpage
\begin{figure}[tbp]
	\centering
	\begin{subfigure}[]
...
La stessa considerazione pu\`o essere fatta anche per quanto riguarda gli eventi di sfocatura, soprattutto nel caso in cui la scena monitorata sia poco dettagliata.
